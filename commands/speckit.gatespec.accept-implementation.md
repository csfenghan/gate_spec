...
From the validated final request/subject and repository diff, present at most 20 lines
covering: delivered observable behavior, actual product/test/build
paths, material symbols/flows, Source manifest conformance when enabled,
bounded IA entries, exact tests and results, remaining limitations/risks, and
mandatory “what I am least confident about”. This is the only normal
implementation-stage user acceptance; checkpoint PASS results continue
automatically and never ask for confirmation.
